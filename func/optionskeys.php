...
*/
	...
	$GrainOpt->defineStringOpt( 'GRAIN_WHOOPS_URL', 'whoops_image_url', GRAIN_TEMPLATE_DIR.'/images/whoops.png' );
		
	// menu and navigation
	$GrainOpt->defineValueOpt("GRAIN_INFOPAGE_ID", "infopage_id", -1 );
	$GrainOpt->defineStringOpt("GRAIN_MNU_PERMALINK_TEXT", "menu_permalink_text", "#" );
	...
	$GrainOpt->defineStringOpt("GRAIN_NAVBAR_LOCATION", "nav_navbar_location", GRAIN_IS_HEADER );
	
	// flat syndication
	$GrainOpt->defineStringOpt("GRAIN_SYND_FLAT_DELIMITER", "synd_flat_delimiter", "/" );
	...
	$GrainOpt->defineStringOpt( 'GRAIN_2NDLANG_TAG', 'feature_2ndl_tag', "grain_2nd_title" );
	...
	$GrainOpt->defineStringOpt( 'GRAIN_MOSAIC_LINKTITLE', 'mosaic_linktitle', __("Mosaic", "grain") );
	...
	$GrainOpt->defineStringOpt( 'GRAIN_COPYRIGHT_END_YEAR', 'copyright_end_year', "%" );
	$GrainOpt->defineStringOpt( 'GRAIN_COPYRIGHT_START_YEAR', 'copyright_start_year', "%" );
	...
	$GrainOpt->defineStringOpt( 'GRAIN_COPYRIGHT_HOLDER', 'copyright_holder', __("(Your name)", "grain") );
	$GrainOpt->defineStringOpt( 'GRAIN_COPYRIGHT_HOLDER_HTML', 'copyright_holder_markup', __("(Your name)", "grain") );
	...
	$GrainOpt->defineStringOpt( 'GRAIN_EYECANDY_COOLPB_URI', 'eyecandy_coolpb_uri', 'http://www.photoblogs.org/profile/defx.de/' );
	$GrainOpt->defineFlagOpt( 'GRAIN_EYECANDY_PBORG_BOOKMARK_ENABLED', 'eyecandy_pborg_bookmark_enabled', FALSE );
	$GrainOpt->defineStringOpt( 'GRAIN_EYECANDY_PBORG_URI', 'http://www.coolphotoblogs.com/?do=profile&id=1324' );
	...
	$GrainOpt->defineStringOpt( 'GRAIN_STYLE_OVERRIDE', "style_override_file", "style.override.css" );
	
	$GrainOpt->defineStringOpt( 'GRAIN_DTFMT_DAILYARCHIVE', 'dtfmt_dailyarchive', __("F jS, Y", "grain") );
	$GrainOpt->defineStringOpt( 'GRAIN_DTFMT_MONTHLYARCHIVE', 'dtfmt_monthlyarchive', __("F, Y", "grain") );
	$GrainOpt->defineStringOpt( 'GRAIN_DTFMT_PUBLISHED', 'dtfmt_published', __("j. F Y, H:i", "grain") );
	$GrainOpt->defineStringOpt( 'GRAIN_DFMT_COMMENTS', 'dtfmt_comment_date', __("F jS, Y", "grain") );
	$GrainOpt->defineStringOpt( 'GRAIN_TFMT_COMMENTS', 'dtfmt_comment_time', __("H:i", "grain") );
	
	$GrainOpt->defineStringOpt( 'GRAIN_OPENTAGS_CATLIST', 'tags_open_catlist', "");
	$GrainOpt->defineStringOpt( 'GRAIN_CLOSETAGS_CATLIST', 'tags_close_catlist', "");
	$GrainOpt->defineStringOpt( 'GRAIN_OPENTAGS_TAGLIST', 'tags_open_taglist', "");
	$GrainOpt->defineStringOpt( 'GRAIN_CLOSETAGS_TAGLIST', 'tags_close_taglist', "");
	$GrainOpt->defineStringOpt( 'GRAIN_TAGLIST_SEPARATOR', 'tags_separator', ", ");
	$GrainOpt->defineStringOpt( 'GRAIN_CATLIST_SEPARATOR', 'cats_separator', ", ");
	...
	$GrainOpt->defineStringOpt( 'GRAIN_IMPRINT_URL', 'imprint_url' );
