		...
		<div id="nonJsForm">
			<form method="post" action="">
				...
				<fieldset>
					...
					grain_admin_checkbox(GRAIN_CONTENT_COMMENTS_HINT, "enable_comments", NULL, __("Enable comments:", "grain"), __("Allow visitors to comment or view existing comments", "grain"), $message);
